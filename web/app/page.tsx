...
function ThreadAnimation() {
  ...
  const threads = [
    { d: "M-100 300 C100 50 300 550 500 300 C700 50 900 550 1100 300", width: 2.5, delay: 0, dur: 3 },
    { d: "M-100 380 C150 130 350 630 550 380 C750 130 950 630 1150 380", width: 1.5, delay: 0.5, dur: 3.5 },
    { d: "M-100 460 C200 210 400 710 600 460 C800 210 1000 710 1200 460", width: 1, delay: 1, dur: 4 },
  ];
  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto text-center">
        ...
        >
          Desenvolvemos fios e materiais reciclados com tecnologia e sustentabilidade.
          Explore nosso catálogo completo de produtos têxteis.
        </motion.p>
...
function MetricCard({
  ...
  return (
    <div className="text-center">
      <h3 className="text-5xl font-bold text-[#008568]">
        +{count}
      </h3>
...
function Metrics() {
  ...
  return (
    <section
      id="metricas"
      ref={ref}
      className="py-32 bg-[#051816] text-white"
    >
...
function Contact() {
  return (
    <section id="contato" className="py-32 bg-[#071a17] text-center text-white">
      <div className="max-w-3xl mx-auto px-6">
        <h2 className="text-6xl font-bold mb-8">
          Vamos <span className="text-[#008568]">conversar</span>
        </h2>

        <p className="text-gray-400 mb-10">
          R. Leopoldo Ewald, 300 — Blumenau, SC
        </p>

        <a
          href="https://wa.me/5547999999999"
          target="_blank"
          className="px-12 py-5 rounded-full bg-[#008568] text-white text-lg font-semibold hover:scale-105 transition"
        >
          Falar no WhatsApp
        </a>
      </div>
